...
INVOICE_NR = "/html/body/div/div/section/main/my-bill-app/div/my-bill-overview-container/div/section/div[3]/div/div/my-bill-billing-account-container/div/div[2]/my-bill-open-transaction-card/div/my-bill-transaction-card-header/div/div/p"
